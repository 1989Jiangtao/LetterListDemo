 ...
 */
package com.cjt.letterlistdemo.QuickAdapter;
...
import com.cjt.letterlistdemo.R;
...
public class BaseAdapterHelper {
	...
	public BaseAdapterHelper setImageUrl(int viewId, String imageUrl) {
		ImageView view = retrieveView(viewId);
		Picasso.with(context).load(imageUrl).placeholder(R.mipmap.ic_launcher).into(view);
		return this;
	}

	public BaseAdapterHelper setImageUrl(int viewId, String imageUrl , int defaultPicRId) {
		ImageView view = retrieveView(viewId);
		Picasso.with(context).load(imageUrl).placeholder(defaultPicRId).into(view);
		return this;
	}
	
	public BaseAdapterHelper setImageUrl(int viewId, String imageUrl, Transformation transformation) {
		ImageView view = retrieveView(viewId);
		Picasso.with(context).load(imageUrl).transform(transformation).placeholder(R.mipmap.ic_launcher)
	...
	public BaseAdapterHelper setMyRating(int viewId, float rating) {
		RatingBar view = retrieveView(viewId);
		view.setRating(rating);
		return this;
	}
